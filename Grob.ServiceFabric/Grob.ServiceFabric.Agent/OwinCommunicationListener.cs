namespace Grob.ServiceFabric.Agent
{
    ...
    public class OwinCommunicationListener : ICommunicationListener
    {
        ...
        public string GrobAgentAddress { get; set; }
        ...
        {
            EndpointResourceDescription serviceEndpoint = serviceInitializationParameters.CodePackageActivationContext.GetEndpoint("WebEndpoint");
            ...
            GrobAgentAddress = publishAddress;
